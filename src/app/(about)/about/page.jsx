  ...
  return (
    <>
      <div className="my-20 flex-col flex lg:grid lg:grid-cols-12">
        <div className="text-8xl col-span-4 font-bold">
          <h1 className="mb-8 lg:pl-8">
            About <span className="text-slate-500">Bitstack</span>
          </h1>
        </div>
        <div className="font-mono col-start-6 col-span-5 max-w-xl lg:max-w-none text-lg md:text-2xl  leading-[130%] text-light-gray font-medium space-y-7">
          <p className="space-y-8 flex flex-col">
            <span>
              <strong>Bitstack</strong> is a collection of resources for developers, designers, and creators. You can
