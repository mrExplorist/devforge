...
export const collabText =
  'We will keep you in loop with latest tech trends , will help you to find best tools and resources based on your needs.';

export const collabContent = [
  {
    id: '0',
    title: 'High quality articles.',
    text: collabText,
  },
  {
    id: '1',
