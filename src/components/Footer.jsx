import { FooterTitle } from '../assets/svg/FooterTitle';
...
export default function Footer() {
  const links = [
    ...
    {
      id: 5,
      href: 'https://github.com/mrExplorist/devforge',
  ...
  return (
    <footer className="mt-32 mb-16 sm:mb-0 px-6 sm:px-[5%]">
      <div className="border-b border-b-zinc-600 pb-6">
        <span className="sr-only">DEVFORGE</span>
        <div className="flex items-center justify-center w-full py-2">
          <h2 className="md:text-[14rem] text-7xl uppercase font-extrabold text-light-gray ">devforge</h2>
        </div>
      </div>
