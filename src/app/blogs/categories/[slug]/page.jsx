...
import BlogLayoutThree from '@/src/components/Blog/BlogLayout';
import Categories from '@/src/components/Blog/Categories';
import TabButtons from '@/src/components/TabNavigation/TabButtons';
...
const CategoryPage = ({ params }) => {
  ...
  return (
    <article className="mt-12 py-16 flex flex-col text-dark dark:text-light">
      ...
      <TabMobile categories={allCategories} currentSlug={params.slug} allBlogs={allBlogs} />
      <TabButtons categories={allCategories} currentSlug={params.slug} allBlogs={allBlogs} />
